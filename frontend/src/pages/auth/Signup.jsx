...
// paste same styles string from Login.jsx above
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .auth-sub { font-size: 0.82rem; color: var(--text-secondary); margin-bottom: 28px; }
  ...
  .role-option {
    ...
    padding: 14px 12px; cursor: pointer; transition: all 0.18s;
  ...
  .role-option-icon { font-size: 22px; margin-bottom: 6px; }
  ...
  .btn-auth {
    width: 100%; background: var(--gold); color: #08090e;
    border: none; padding: 13px; border-radius: 11px;
  ...
  .btn-auth:hover:not(:disabled) {
    background: #e8bc55; box-shadow: 0 0 24px var(--gold-glow);
...
export default function Signup() {
  ...
  const [form, setForm] = useState({ name: "", email: "", password: "", role: "affiliate" });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user.role === "seller") navigate("/affiliate/products");
    ...
    <>
      ...
      <div className="auth-page">
        <div className="auth-card">
          ...
          <p className="auth-sub">Join as a seller or affiliate</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="auth-field">
              ...
              <input
                className="auth-input" type="password" placeholder="Min 8 characters"
                value={form.password}
            ...
            <div className="auth-field">
              ...
              <div className="role-selector">
                <div
                  className={`role-option ${form.role === "affiliate" ? "selected" : ""}`}
                  onClick={() => setForm({ ...form, role: "affiliate" })}
                >
                  <div className="role-option-icon">🚀</div>
                  <div className="role-option-label">Affiliate</div>
                  <div className="role-option-desc">Promote & earn</div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="role-option-desc">List & sell</div>
                </div>
              </div>
            </div>
